...
// Si une action de suppression est demandée
if (isset($_GET['id'])) {
    $comment_id = $_GET['id'];

    // Appel de la méthode deleteComment() de l'Admin pour supprimer le commentaire
    $admin->deleteComment($comment_id);
...
// Utiliser la méthode query() de la classe Database pour exécuter la requête SQL
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="manage_comments.php?id=<?php echo $row['id']; ?>" class="font-medium text-red-600 hover:underline">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
